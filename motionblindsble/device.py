...
class MotionDevice:
    ...
    _create_task: CreateTask | None = None
    _call_later: CallLater | None = None
    ...
    _end_position_callbacks: list[Callable[[MotionPositionInfo | None], None]]
    ...
    def set_create_task_factory(self, _create_task: CreateTask) -> None:
        """Set the create_task function to use."""
        self._create_task = _create_task

    def set_call_later_factory(self, _call_later: CallLater) -> None:
    ...
    def _notification_callback(
        ...
        if decrypted_message.startswith(MotionNotificationType.FEEDBACK.value):
            ...
            position = decrypted_message_bytes[6]
            tilt = decrypted_message_bytes[7]
    ...
    def update_end_position_info(
        ...
        self.update_calibration(
            ...
            if end_position_info is None
                ...
                if end_position_info.end_positions is MotionEndPositions.BOTH
